...
/**
 * Standard distance formatter with configurable thresholds
 */
export class StandardDistanceFormatter implements DistanceFormatter {
  /**
...
export const standardFormatter = new StandardDistanceFormatter();
