              ...
              {guestNavItems.map(item => {
                ...
                return (
                  <Link 
                    key={item.path} 
                    to={item.path} 
                    className={`guest-nav-link px-3 py-2 rounded-md flex items-center transition-all ${isActive ? 'bg-white/20 text-white font-medium' : 'text-white/80 hover:text-white hover:bg-white/10'}`}
                  >
