...
const KeyFeatures = () => {
    ...
    backgroundPosition: "center"
  }} role="region" aria-labelledby="features-heading" className="py-20 px-4 bg-[#ffc99e]">
      <div className="container mx-auto">
        ...
        duration: 0.5
          ...
          <h2 id="features-heading" className="text-3xl font-bold mb-4 border-b-4 border-spiritless-pink inline-block pb-2 text-[#590202]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          duration: 0.5,
          delay: feature.delay
        }} role="article" aria-labelledby={`feature-heading-${index}`} className="">
              <div className="bg-white/20 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-4 mx-auto" aria-hidden="true">
                {feature.icon}
              </div>
              <h3 id={`feature-heading-${index}`} className="text-xl font-bold mb-3 text-center">
                {feature.title}
              </h3>
