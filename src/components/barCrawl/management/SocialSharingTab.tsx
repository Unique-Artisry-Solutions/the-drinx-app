        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                value={`${window.location.origin}/swig-circuit/${swigCircuit.id}`}
                readOnly
          ...
          <div className="border rounded-md p-4 bg-gray-50">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h4 className="font-medium">{swigCircuit.name}</h4>
                <p className="text-sm text-gray-600 mb-1">
                  {format(new Date(swigCircuit.startDate), 'MMM d')} - {format(new Date(swigCircuit.endDate), 'MMM d, yyyy')}
                </p>
                <p className="text-sm text-gray-600">
                  {swigCircuit.establishments.length} establishments • Organized by {swigCircuit.organizer}
                </p>
              </div>
            </div>
          </div>
