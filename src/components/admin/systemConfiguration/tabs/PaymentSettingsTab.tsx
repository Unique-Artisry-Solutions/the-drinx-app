...
import { Plus, Info, CreditCard, BarChart, TestTube } from 'lucide-react';
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    ...
                    <p className="mt-1">For security reasons, changing this setting requires a reason to be provided and is validated to be between 0-10%.</p>
                    <p className="mt-1">Revenue from service fees is tracked in the analytics dashboard.</p>
                    <p className="mt-2">
                      <Button 
                        size="sm" 
                        variant="ghost" 
                        className="gap-1 text-blue-700 hover:text-blue-800 p-0 h-auto"
                        onClick={() => navigate('/service-fee-test')}
                      >
