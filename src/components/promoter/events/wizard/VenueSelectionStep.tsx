...
const mockVenues: Venue[] = [
  { id: '1', name: 'The Purple Lounge', address: '123 Main St, City' },
  { id: '2', name: 'Skybar', address: '456 Park Ave, City' },
  { id: '3', name: 'Ocean View', address: '789 Beach Rd, Coast City' },
  { id: '4', name: 'The Rooftop', address: '101 High St, Downtown' },
];
