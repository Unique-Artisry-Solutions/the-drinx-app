...
import MessagingWidget from './dashboard/MessagingWidget';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Messaging Widget - Takes up one column */}
        <MessagingWidget />
        
        {/* Recent Activity - Takes up one column */}
        <Card>
          <CardHeader>
        ...
        {/* Performance Overview - Takes up one column */}
        <Card>
          <CardHeader>
