...
const EstablishmentInterior: React.FC<EstablishmentInteriorProps> = ({
  ...
  return (
    <div className="animate-fade-in vibrant-bg rounded-xl p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          <Tabs defaultValue="menu">
            <TabsList className="w-full mb-4 bg-gradient-to-r from-spiritless-pink/10 to-spiritless-orange/10 p-1 rounded-xl">
              ...
              <Card className="vibrant-card">
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    ...
                    <div className="pt-4">
                      <h3 className="font-medium mb-2 gradient-text text-lg">Business Hours</h3>
                    ...
                    <div className="pt-4">
                      <h3 className="font-medium mb-2 gradient-text text-lg">About</h3>
            ...
            <TabsContent value="top-rated">
              <div className="space-y-4">
                {topRatedCocktails.length > 0 ? <>
                    <h3 className="text-lg font-medium mb-3 vibrant-header">Most Popular Mocktails</h3>
        ...
        <div className="space-y-4">
          <Card className="vibrant-card">
            <CardHeader>
              <CardTitle className="text-lg gradient-text">Location</CardTitle>
            </CardHeader>
          ...
          <Card className="vibrant-card">
            <CardHeader>
              <CardTitle className="text-lg gradient-text">Bar Crawl Information</CardTitle>
            </CardHeader>
            <CardContent>
