...
// Unified Mobile Service - consolidates mobile analytics and functionality
...
export class UnifiedMobileService {
  ...
  static async initialize(): Promise<void> {
    ...
    if (config.enableLogging) {
      console.log('UnifiedMobileService: Initializing...');
    }
  ...
  static async getMobileUsageMetrics(promoterId: string): Promise<MobileUsageMetrics> {
  ...
  // Location analytics
  static async getLocationAnalytics(promoterId: string): Promise<LocationAnalyticsMetrics> {
  ...
  static async getPushNotificationMetrics(promoterId: string): Promise<PushNotificationMetrics> {
  ...
  static async getMobileConversionMetrics(promoterId: string): Promise<MobileConversionMetrics> {
  ...
  static async healthCheck(): Promise<boolean> {
    try {
      await this.getMobileUsageMetrics('test');
      return true;
    } catch (error) {
      console.error('UnifiedMobileService health check failed:', error);
      return false;
    }
  }
}
