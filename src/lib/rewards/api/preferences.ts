...
export const getUserPreference = async (userId: string, key: string): Promise<ApiUserRewardPreference | null> => {
...
export const setUserPreference = async (userId: string, key: string, value: any): Promise<void> => {
  // Mock implementation - replace with actual API call
