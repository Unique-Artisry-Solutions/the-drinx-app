...
import { Map, Route, Building } from 'lucide-react';
  ...
  return (
    <Layout>
      <div className="animate-fade-in max-w-7xl mx-auto">
        ...
        {/* Bar Crawl Section */}
        <div className="mb-4 p-4 bg-gradient-to-r from-spiritless-pink/10 to-spiritless-green/10 rounded-lg border border-spiritless-pink/20">
