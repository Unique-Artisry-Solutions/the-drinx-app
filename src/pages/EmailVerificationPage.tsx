          ...
          <CardContent className="space-y-6">
            <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-amber-800">Verification needed</h3>
            ...
            <div className="space-y-4">
              <div className="flex flex-col space-y-3">
                ...
                <Button
                  variant="default"
                  className="flex items-center justify-center space-x-2 bg-spiritless-pink hover:bg-spiritless-pink/90"
              ...
              <div className="text-center pt-4 border-t border-gray-200 mt-4">
                <Link to="/logout" className="text-sm text-gray-600 hover:text-gray-900">
