...
import { Upload, Camera, PlusCircle, Trash } from 'lucide-react';
...
const EstablishmentProfilePage = () => {
  ...
  useEffect(() => {
    // In a real app, this would fetch the establishment data from an API
    setTimeout(() => {
      ...
      <div className="py-4 animate-fade-in">
        ...
        <Tabs defaultValue="profile">
          ...
          <TabsContent value="barCrawls">
            <Card>
              <CardHeader>
                <CardTitle>Bar Crawl Requests</CardTitle>
              </CardHeader>
              <CardContent>
