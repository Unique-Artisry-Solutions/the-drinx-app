...
const LandingPage = () => {
  ...
  return <div className="landing-page min-h-screen w-full">
      {/* Only show floating cart button if there are items in the cart and user has scrolled */}
      {hasCartItems && isScrolled && <div className="fixed bottom-6 right-6 z-50 animate-fade-in">
      ...
      {hasCartItems && <div className={`fixed top-0 left-0 right-0 z-50 transition-opacity duration-300 ${isScrolled ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
