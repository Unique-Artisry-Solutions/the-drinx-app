...
INSERT INTO promoter_venue_threads (
  ...
  gen_random_uuid(),
  '1693e1ac-572d-4b36-aeb3-15f121ce2888'::uuid, -- testpromoter
  '9f5c8180-844b-4fab-8df1-47cf76be4b1c'::uuid, -- The Mocktail Lounge
...
INSERT INTO promoter_venue_threads (
  ...
  gen_random_uuid(),
  '1693e1ac-572d-4b36-aeb3-15f121ce2888'::uuid, -- testpromoter
  '202aa105-9d24-4bfd-87de-b80608852ebd'::uuid, -- Zero Proof
...
WITH mocktail_thread AS (
  ...
  WHERE promoter_id = '1693e1ac-572d-4b36-aeb3-15f121ce2888'::uuid 
  AND venue_id = '9f5c8180-844b-4fab-8df1-47cf76be4b1c'::uuid
),
zero_proof_thread AS (
  SELECT id FROM promoter_venue_threads 
  WHERE promoter_id = '1693e1ac-572d-4b36-aeb3-15f121ce2888'::uuid 
  AND venue_id = '202aa105-9d24-4bfd-87de-b80608852ebd'::uuid
)
...
SELECT 
  gen_random_uuid(),
  mocktail_thread.id,
  '1693e1ac-572d-4b36-aeb3-15f121ce2888'::uuid, -- testpromoter as sender
...
SELECT 
  gen_random_uuid(),
  mocktail_thread.id,
  '6531c6f1-9aa8-4f7e-9e5e-cf29b85455f6'::uuid, -- testbar as sender
